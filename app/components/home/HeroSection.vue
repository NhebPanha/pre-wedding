<template>
    <section class="relative">
        <div class="max-w-[1440px] mx-auto lg:p-6">
            <div
                ...
                <div class="absolute inset-0 bg-cover bg-center"
                    style="background-image: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.6)), url('https://i.pinimg.com/1200x/13/50/3c/13503c6f3ac753324a55f27589231125.jpg');">
                </div>
                <div class="relative z-10 max-w-4xl space-y-6">
                    <div
                        class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs font-bold uppercase tracking-[0.2em] mb-4">
                        <span class="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
                        ប្រពៃណី និង សិល្បៈ
                    </div>
                    <h1 class="text-4xl md:text-7xl font-black text-white leading-[1.3] tracking-tight">
                        ការផ្តិតយកចំណងស្នេហ៍ <br /><span class="text-primary italic">ដ៏នៅអមតៈ</span> របស់លោកអ្នក
                    </h1>
                    <p class="text-white/80 text-lg md:text-xl font-normal max-w-2xl mx-auto leading-relaxed">
